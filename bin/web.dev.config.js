...
if(process.env.REACT_BUILD_DEV_LINT != 'disabled') {
...
if(process.env.REACT_BUILD_DEV_CACHE == 'enabled') {
  ...
  webpackPlugins.push(
    new HardSourceWebpackPlugin({
      cacheDirectory: path.join('../../build-cache', 'dev', '[confighash]'),
      recordsPath: path.join('../../build-cache', 'dev', '[confighash]', 'records.json'),
